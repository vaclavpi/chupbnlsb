...
class _DetailPageState extends State<DetailPage> {
  ...
  final String placeId = 'ChIJnViDs-rxC0cRSjUD9fLW4fE'; // Nahraďte ID místem, které chcete zobrazit
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(image: AssetImage(detail.places.img),
                  fit: BoxFit.cover
                ),
                ),
            )),
                ...
                children: [
                  Container(
                    decoration: BoxDecoration(
                      ...
                      shape: BoxShape.circle, // Tvar pozadí (v tomto případě kruh)
                    ),
                ...
                child:  Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Expanded(child: AppLargeText(text: detail.places.name, color:AppColors.fourthColor, size: 30,)),
                      ],
                    ),
                    SizedBox(height: 10,),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Icon(Icons.location_on, color: AppColors.thirdColor,),
                        SizedBox(height: 5,),
                        AppBoldText(text: detail.places.location, size: 14, color: AppColors.thirdColor)
                      ],
                    ),
                    SizedBox(height: 10,),
                    Row(
                    ...
                    SizedBox(height: 30,),
                    AppLargeText(text: "O tomto objektu:", color: AppColors.thirdColor, size: 23,),
                    SizedBox(height: 10,),
                    Expanded(
                      child: SingleChildScrollView(
                        scrollDirection: Axis.vertical,
                        child:AppText(text: detail.places.description, color: AppColors.mainColor)),
                )],
                ),
              ),
            )
  ...
  Widget buildStarRating(double rating) {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      Color starColor = i < rating ? AppColors.fifthColor:AppColors.secondColor;
      stars.add(
        Icon(
          starIcon,
          color: starColor,
